...
import 'package:meetzone/controllers/signup_controller.dart';
...
class _SignupViewState extends State<SignupView> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    // This is the golden pattern for any form screen in 2025
    return GestureDetector(
      ...
      child: Scaffold(
        resizeToAvoidBottomInset: false, // Button stays at bottom
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      // FIXED BOTTOM SECTION (button + login link)
                      Column(
                        children: [
                          SizedBox(
